...
public class DinnerDescView extends RelativeLayout implements OnClickListener {
	...
	public DinnerDescView(Context context, AttributeSet attrs, String _DId,
	...
	private void init_data() {
		arrList = bllGet.getDinnerFood(strDId);
