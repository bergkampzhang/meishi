...
public class UserNavigateBar extends LinearLayout {
	private Button btnLeft;
	private Button btnRight;
	private TextView tvBarText;
	private OnUserNavRightClickListener onRightClickListener;
	private OnUserNavLeftClickListener onLeftClickListener;

	public UserNavigateBar(Context context) {
		this(context, null);
	}

	public UserNavigateBar(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void setOnUserNavRightClickListener(OnUserNavRightClickListener click) {
		this.onRightClickListener = click;
	}

	public void setOnUserNavLeftClickListener(OnUserNavLeftClickListener click) {
