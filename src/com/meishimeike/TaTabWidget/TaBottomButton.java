...
public class TaBottomButton extends RelativeLayout {
	private ImageView imgbtn;
	private OnTaBottomButtonClickListener onBottomButtonClickListener;
	
	public TaBottomButton(Context context) {
		super(context);
	}
	
	public TaBottomButton(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void setOnBottomButtonClickListener(OnTaBottomButtonClickListener click) {
