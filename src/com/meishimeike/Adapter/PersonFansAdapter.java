 ...
 */
public class PersonFansAdapter extends BaseAdapter {
	...
	public PersonFansAdapter(Context context, ArrayList<BeanUserInfo> arr) {
		mContext = context;
	...
	public View getView(final int pos, View cView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.person_fans_item, null);
